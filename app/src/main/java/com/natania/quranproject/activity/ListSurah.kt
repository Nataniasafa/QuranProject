package com.natania.quranproject.activity
...
import com.natania.quranproject.R
import com.natania.quranproject.adapter.SurahAdapter
import com.natania.quranproject.detail.DetailSurahActivity
import com.natania.quranproject.fragment.FragmentJadwalSholat
import com.natania.quranproject.model.ModelSurah
import com.natania.quranproject.network.Api
import com.natania.quranproject.utils.GetAddressIntentService
...
class ListSurah : AppCompatActivity() , SurahAdapter.onSelectDataa {
    ...
    private var addressResultReceiver: ListSurah.LocationAddressResultReceiver? = null
    ...
    override fun onSelected(modelSurah: ModelSurah?) {
        val intent = Intent(
            this@ListSurah,
            DetailSurahActivity::class.java
        )
